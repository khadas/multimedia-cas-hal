...
typedef enum _uc_service_message_type
{
    ...
    /** (0x00000012) VOD ECM PID list message type for the ::uc_service_message_proc callback
     *
     * This message is used to notify VOD ECM PID list.
     * This message is notified after notifying PMT of a VOD service.
     *
     * For messages with this type, the \a lpVoid argument is a pointer to
     * a structure of type ::uc_vod_service_ecm_pid_list_st.
     */
    UC_SERVICE_VOD_ECM_PID_LIST = 0x00000012,

    /** (0x00000013) VOD ECM reply message type for the ::uc_service_message_proc callback
     *
     * This message is used to notify VOD ECM reply.
     * This message is notified after processing the ECM on a VOD service.
     *
     * For messages with this type, the \a lpVoid argument is a pointer to
     * a structure of type ::uc_vod_service_ecm_reply_st.
     */
    UC_SERVICE_VOD_ECM_REPLY = 0x00000013
...
/**
 * Structure for VOD ECM PID list notification.
 *
 * This is the structure that is passed as the \a lpVoid argument of 
 * ::uc_service_message_proc when the \a message argument is ::UC_SERVICE_VOD_ECM_PID_LIST.
 */
typedef struct _uc_vod_service_ecm_pid_list_st
{
    /**
     * The service handle
     *
    ...
    /**
     * Indicates the count of ECM PIDs.
     *
     */
    uc_uint32 ecmPidCount;

    /**
     * Indicates what ECM is needed according to PIDs.
     *
     */
    uc_uint16 ecmPids[UC_MAX_VOD_ECM_PID_COUNT];
} uc_vod_service_ecm_pid_list_st;

/**
 * Structure for VOD ECM reply notification.
 *
 * This is the structure that is  passed as the \a lpVoid argument of
 * ::uc_service_message_proc when the \a message argument is ::UC_SERVICE_VOD_ECM_REPLY.
 */
typedef struct _uc_vod_service_ecm_reply_st
{
    /** Service handle previously opened by a call to ::UniversalClient_OpenService.
     */
    uc_service_handle  serviceHandle;
    ...
    /** User data in caller area.
     */
    uc_uint32 userData;

    /** Flag to indicate whether CW can be set to the descrambler.
     */
    uc_bool authorized;

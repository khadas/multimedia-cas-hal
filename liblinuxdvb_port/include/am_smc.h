 ...
 * \return Error code
 */
int AM_SMC_ReadEx(int dev_no, uint8_t *data, int *act_len, int len, int timeout);
 ...
 * \return Error code
 */
int AM_SMC_WriteEx(int dev_no, const uint8_t *data, int *act_len, int len, int timeout);
